...
Now, during setup you might want to use a common name like "firebase" or your name or initals. I did not on this project, opting instead to use objects inside my env config file. When the install is done running you will want to edit the `.quasar.env.json` inserting the firebase config info for your production and staging environments. Mine looks like this...
